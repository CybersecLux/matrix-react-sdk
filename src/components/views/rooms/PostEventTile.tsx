...
@replaceableComponent("views.rooms.PostEventTile")
export default class PostEventTile extends React.Component<IProps, IState> {
    ...
    getReadAvatars() {
        ...
        if (!this.props.readReceipts || this.props.readReceipts.length === 0) {
            return (<span className="mx_PostEventTile_readAvatars" />);
        }
        ...
        if (!this.state.allReadAvatars) {
            ...
            if (remainder > 0) {
                remText = <span className="mx_PostEventTile_readAvatarRemainder"
                    onClick={this.toggleAllReadAvatars}
    ...
    render() {
        ...
        if (!tileHandler) {
            ...
            return <div className={"mx_PostEventTile mx_PostEventTile_info mx_MNoticeBody "
                + "mx_PostEventTile_level_" + this.props.level}>
                <div className="mx_PostEventTile_line">
        ...
        const classes = classNames({
            mx_PostEventTile_bubbleContainer: isBubbleMessage,
            mx_PostEventTile: true,
            ["mx_PostEventTile_level_" + this.props.level]: true,
            mx_PostEventTile_isEditing: isEditing,
            mx_PostEventTile_info: isInfoMessage,
            mx_PostEventTile_12hr: this.props.isTwelveHour,
            // Note: we keep the `sending` state class for tests, not for our styles
            mx_PostEventTile_sending: !isEditing && isSending,
            mx_PostEventTile_highlight: this.props.tileShape === 'notif' ? false : this.shouldHighlight(),
            mx_PostEventTile_selected: this.props.isSelectedEvent,
            mx_PostEventTile_continuation: this.props.tileShape ? '' : this.props.continuation,
            mx_PostEventTile_last: this.props.last,
            mx_PostEventTile_lastInSection: this.props.lastInSection,
            mx_PostEventTile_contextual: this.props.contextual,
            mx_PostEventTile_actionBarFocused: this.state.actionBarFocused,
            mx_PostEventTile_verified: !isBubbleMessage && this.state.verified === E2E_STATE.VERIFIED,
            mx_PostEventTile_unverified: !isBubbleMessage && this.state.verified === E2E_STATE.WARNING,
            mx_PostEventTile_unknown: !isBubbleMessage && this.state.verified === E2E_STATE.UNKNOWN,
            mx_PostEventTile_bad: isEncryptionFailure,
            mx_PostEventTile_emote: msgtype === 'm.emote',
        });
        ...
        if (this.props.mxEvent.sender && avatarSize) {
            ...
            avatar = (
                <div className="mx_PostEventTile_avatar">
        ...
        const keyRequestHelpText =
            <div className="mx_PostEventTile_keyRequestInfo_tooltip_contents">
                <p>
        ...
        const keyRequestInfo = isEncryptionFailure && !isRedacted ?
            <div className="mx_PostEventTile_keyRequestInfo">
                <span className="mx_PostEventTile_keyRequestInfo_text">
        ...
        if (this.props.showReadReceipts) {
            ...
            msgOption = (
                <div className="mx_PostEventTile_msgOption">
                    { readAvatars }
                </div>
            );
        }
            ...
            case 'notif': /* TODO {
                ...
                return (
                    <div className={classes} aria-live={ariaLive} aria-atomic="true">
                        <div className="mx_PostEventTile_roomName">
                            <RoomAvatar room={room} width={28} height={28} />
                            <a href={permalink} onClick={this.onPermalinkClicked}>
                                { room ? room.name : '' }
                            </a>
                        </div>
                        <div className="mx_PostEventTile_senderDetails">
                            { avatar }
                            <a href={permalink} onClick={this.onPermalinkClicked}>
                                { sender }
                                { timestamp }
            ...
            case 'file_grid': /* TODO {
                return (
                    <div className={classes} aria-live={ariaLive} aria-atomic="true">
                        ...
                        <a
                            className="mx_PostEventTile_senderDetailsLink"
                            href={permalink}
                            onClick={this.onPermalinkClicked}
                        >
                            <div className="mx_PostEventTile_senderDetails">
            ...
            case 'reply_preview': /* TODO {
                ...
                return (
                    <div className={classes} aria-live={ariaLive} aria-atomic="true">
                        ...
                        { sender }
                        { ircPadlock }
                        <div className="mx_PostEventTile_reply">
                            { groupTimestamp }
                            { groupPadlock }
                            { thread }
                            <EventTileType ref={this.tile}
...
class E2ePadlock extends React.Component<IE2ePadlockProps, IE2ePadlockState> {
    ...
    render() {
        let tooltip = null;
        if (this.state.hover) {
            tooltip = <Tooltip className="mx_PostEventTile_e2eIcon_tooltip" label={this.props.title} />;
        }

        const classes = `mx_PostEventTile_e2eIcon mx_PostEventTile_e2eIcon_${this.props.icon}`;
        return (
            <div
                className={classes}
...
class SentReceipt extends React.PureComponent<ISentReceiptProps, ISentReceiptState> {
    ...
    render() {
        ...
        const receiptClasses = classNames({
            'mx_PostEventTile_receiptSent': isSent,
            'mx_PostEventTile_receiptSending': !isSent && !isFailed,
        });
        ...
        if (this.state.hover) {
            ...
            tooltip = <Tooltip className="mx_PostEventTile_readAvatars_receiptTooltip" label={label} yOffset={20} />;
        }
